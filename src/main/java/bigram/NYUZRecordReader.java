...
import parser.PartitionedJsonParser;
 ...
 */
public class NYUZRecordReader extends RecordReader<LongWritable, Text> {
    private static final Log log = LogFactory.getLog(NYUZRecordReader.class);
    ...
    private PartitionedJsonParser parser = null;
    private final String jsonMemberName;

    public NYUZRecordReader(String jsonMemberName) {
